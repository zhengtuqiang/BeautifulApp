...
import com.jogger.beautifulapp.util.DoubleClickQuitHelper;
...
public class MainActivity extends BaseActivity<MainPresenter> implements MainContract.View {
    ...
    private DoubleClickQuitHelper mQuitHelper = new DoubleClickQuitHelper();
            ...
            try {
                ...
                try {
                    ...
                    transaction.add(R.id.fl_main_container, fragment,
                            cls.getName());
                    mShowFragment = fragment;//并将当前显示fragment设为添加的fragment
